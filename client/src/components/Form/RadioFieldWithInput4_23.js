...
function RadioFieldWithInput4_23(props) {
	...
	function enableDisableTextBoxYes(id, isChecked) {
	    var yesBox = document.getElementById("yes4_23");
	...
	const handleYesInput = async(event) => {
		localStorage.setItem('4.23-1-yes', event.target.value);
	};
...
export default RadioFieldWithInput4_23;
