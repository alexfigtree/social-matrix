...
import { canvas } from 'canvas-toBlob';
...
const Results = () => {
    ...
    function saveSVG() {
        ...
        //d3.select('#saveButton').on('click', function(){
            var svgString1 = getSVGString(d3.select('body').node());
            console.log('svgString1', svgString1);
            svgString2Image( svgString1, 1600, 1200, 'png', save ); // passes Blob and filesize String to the callback

            function save( dataBlob, filesize ){
                console.log('save called with dataBlob', dataBlob);
    ...
    function getSVGString( svgNode ) {
        //console.log('getSVGString called with node', svgNode);
        ...
        function getCSSStyles( parentElement ) {
            console.log('getCSSStyles called');
            var selectorTextArr = [];
  ...
  return (
    <div className="container">
        ...
        <div>
          ...
          <button id='saveButton' onClick={saveSVG}>Export my Matrix to PNG</button>
