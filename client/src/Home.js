...
const Home = () => {
  ...
  useEffect(() => {
    ...
    localStorage.setItem('subjectData', JSON.stringify(tempData));
   
  }, []);


    
  const [subjectData, setSubjectData] = useState(localStorage.getItem('subjectData'));
  console.log('SUBJECT DARTA', subjectData);
            ...
            sets: [
              {
                ...
                label: 'P1',
                values: {
                  educLevel: subjectData[0][0].value,
                  guardiansEduc: subjectData[0][33].value,
                  occupation: subjectData[0][32].value,
                  guardiansOccup: subjectData[0][31].value,
                  householdIncome: subjectData[0][30].value,
                  childhoodIncome: subjectData[0][29].value,
                  guardiansChildHouseIncome: subjectData[0][28].value,
                  access: subjectData[0][27].value,
                  guardiansAccess: subjectData[0][26].value,
                  race: subjectData[0][25].value,
                  ethnicity: subjectData[0][24].value,
                  nationOfOriginCitizenship: subjectData[0][23].value,
                  languages: subjectData[0][22].value,
                  familyReligion: subjectData[0][21].value,
                  chosenReligion: subjectData[0][20].value,
                  politics: subjectData[0][19].value,
                  geoRegion: subjectData[0][18].value,
                  impactHistTimes: subjectData[0][17].value,
                  relationToMilitary: subjectData[0][16].value,
                  relationLegalSystem: subjectData[0][15].value,
                  mHSubstUse: subjectData[0][14].value,
                  cognitiveAbilityStyle: subjectData[0][13].value,
                  healthAbility: subjectData[0][12].value,
                  appearance: subjectData[0][11].value,
                  age: subjectData[0][10].value,
                  raisedBy: subjectData[0][9].value,
                  guardiansMaritalStatus: subjectData[0][8].value,
                  parentalStatus: subjectData[0][7].value,
                  maritalStatus: subjectData[0][6].value,
                  sexualOrientation: subjectData[0][5].value,
                  genderID: subjectData[0][4].value,
                  genderExpression: subjectData[0][3].value,
                  sexAtBirth: subjectData[0][2].value,
                  uniqueHistory: subjectData[0][1].value,
                },
              },
              {
                key: 'pre-large',
                label: 'P2',
                values: {
                  educLevel: subjectData[1][0].value,
                  guardiansEduc: subjectData[1][33].value,
                  occupation: subjectData[1][32].value,
                  guardiansOccup: subjectData[1][31].value,
                  householdIncome: subjectData[1][30].value,
                  childhoodIncome: subjectData[1][29].value,
                  guardiansChildHouseIncome: subjectData[1][28].value,
                  access: subjectData[1][27].value,
                  guardiansAccess: subjectData[1][26].value,
                  race: subjectData[1][25].value,
                  ethnicity: subjectData[1][24].value,
                  nationOfOriginCitizenship: subjectData[1][23].value,
                  languages: subjectData[1][22].value,
                  familyReligion: subjectData[1][21].value,
                  chosenReligion: subjectData[1][20].value,
                  politics: subjectData[1][19].value,
                  geoRegion: subjectData[1][18].value,
                  impactHistTimes: subjectData[1][17].value,
                  relationToMilitary: subjectData[1][16].value,
                  relationLegalSystem: subjectData[1][15].value,
                  mHSubstUse: subjectData[1][14].value,
                  cognitiveAbilityStyle: subjectData[1][13].value,
                  healthAbility: subjectData[1][12].value,
                  appearance: subjectData[1][11].value,
                  age: subjectData[1][10].value,
                  raisedBy: subjectData[1][9].value,
                  guardiansMaritalStatus: subjectData[1][8].value,
                  parentalStatus: subjectData[1][7].value,
                  maritalStatus: subjectData[1][6].value,
                  sexualOrientation: subjectData[1][5].value,
                  genderID: subjectData[1][4].value,
                  genderExpression: subjectData[1][3].value,
                  sexAtBirth: subjectData[1][2].value,
                  uniqueHistory: subjectData[1][1].value,
                },
              },
            ],
          }}
            ...
            sets: [
              {
                ...
                label: 'P1',
                values: {
                  educLevel: subjectData[2][0].value,
                  guardiansEduc: subjectData[2][33].value,
                  occupation: subjectData[2][32].value,
                  guardiansOccup: subjectData[2][31].value,
                  householdIncome: subjectData[2][30].value,
                  childhoodIncome: subjectData[2][29].value,
                  guardiansChildHouseIncome: subjectData[2][28].value,
                  access: subjectData[2][27].value,
                  guardiansAccess: subjectData[2][26].value,
                  race: subjectData[2][25].value,
                  ethnicity: subjectData[2][24].value,
                  nationOfOriginCitizenship: subjectData[2][23].value,
                  languages: subjectData[2][22].value,
                  familyReligion: subjectData[2][21].value,
                  chosenReligion: subjectData[2][20].value,
                  politics: subjectData[2][19].value,
                  geoRegion: subjectData[2][18].value,
                  impactHistTimes: subjectData[2][17].value,
                  relationToMilitary: subjectData[2][16].value,
                  relationLegalSystem: subjectData[2][15].value,
                  mHSubstUse: subjectData[2][14].value,
                  cognitiveAbilityStyle: subjectData[2][13].value,
                  healthAbility: subjectData[2][12].value,
                  appearance: subjectData[2][11].value,
                  age: subjectData[2][10].value,
                  raisedBy: subjectData[2][9].value,
                  guardiansMaritalStatus: subjectData[2][8].value,
                  parentalStatus: subjectData[2][7].value,
                  maritalStatus: subjectData[2][6].value,
                  sexualOrientation: subjectData[2][5].value,
                  genderID: subjectData[2][4].value,
                  genderExpression: subjectData[2][3].value,
                  sexAtBirth: subjectData[2][2].value,
                  uniqueHistory: subjectData[2][1].value,
                },
              },
              {
                key: 'post-large',
                label: 'P2',
                values: {
                  educLevel: subjectData[3][0].value,
                  guardiansEduc: subjectData[3][33].value,
                  occupation: subjectData[3][32].value,
                  guardiansOccup: subjectData[3][31].value,
                  householdIncome: subjectData[3][30].value,
                  childhoodIncome: subjectData[3][29].value,
                  guardiansChildHouseIncome: subjectData[3][28].value,
                  access: subjectData[3][27].value,
                  guardiansAccess: subjectData[3][26].value,
                  race: subjectData[3][25].value,
                  ethnicity: subjectData[3][24].value,
                  nationOfOriginCitizenship: subjectData[3][23].value,
                  languages: subjectData[3][22].value,
                  familyReligion: subjectData[3][21].value,
                  chosenReligion: subjectData[3][20].value,
                  politics: subjectData[3][19].value,
                  geoRegion: subjectData[3][18].value,
                  impactHistTimes: subjectData[3][17].value,
                  relationToMilitary: subjectData[3][16].value,
                  relationLegalSystem: subjectData[3][15].value,
                  mHSubstUse: subjectData[3][14].value,
                  cognitiveAbilityStyle: subjectData[3][13].value,
                  healthAbility: subjectData[3][12].value,
                  appearance: subjectData[3][11].value,
                  age: subjectData[3][10].value,
                  raisedBy: subjectData[3][9].value,
                  guardiansMaritalStatus: subjectData[3][8].value,
                  parentalStatus: subjectData[3][7].value,
                  maritalStatus: subjectData[3][6].value,
                  sexualOrientation: subjectData[3][5].value,
                  genderID: subjectData[3][4].value,
                  genderExpression: subjectData[3][3].value,
                  sexAtBirth: subjectData[3][2].value,
                  uniqueHistory: subjectData[3][1].value,
                },
              },
            ],
          }}
